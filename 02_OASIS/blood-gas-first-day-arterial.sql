...
DROP VIEW IF EXISTS bloodgasfirstdayarterial ;
...
left join stg_spo2 s1
  ...
  and s1.charttime between dateadd(hour,-2,bg.charttime) and bg.charttime
...
left join stg_fio2 s2
  ...
  and s2.charttime between dateadd(hour,-4,bg.charttime) and bg.charttime
